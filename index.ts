...
export const Player = new Fish(200, 300, 1.5, FishWidth * 0.17, FishHeight * 0.17, IMAGE.main);
...
const move = () => {
    ...
    Player.width = Math.max(FishWidth * 0.05, Player.width * 0.99999);
    Player.height = Math.max(FishHeight * 0.05, Player.height * 0.99999);
}
