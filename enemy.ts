...
export class Enemy extends Fish {
    ...
    crash() {
        if (d2d(Player.mx, Player.my, this.mx, this.my) <= Math.max(this.height, Player.height) * 0.3) {
            ...
            if (PlayerDelta >= 0.2) document.querySelectorAll('ul.fishList li')[1].classList.add('active')
            if (PlayerDelta >= 0.4) document.querySelectorAll('ul.fishList li')[2].classList.add('active')
            if (PlayerDelta >= 0.5) document.querySelectorAll('ul.fishList li')[3].classList.add('active')
            if (PlayerDelta >= 0.6) document.querySelectorAll('ul.fishList li')[4].classList.add('active')
            if (PlayerDelta >= 1) document.querySelectorAll('ul.fishList li')[5].classList.add('active')
        }
